...
| [`maxValueY?`](#максимальное-значение-оси-У)                | `number`                                    | -            | Устанавливает максимальное значение для оси У                               |             |
| [`minValueY?`](#минимальное-значение-оси-У)                 | `number`                                    | -            | Устанавливает минимальное значение для оси У                                |
| [`minCategorySizeLimit?`](#минимальный-размер-категории)| `boolean`                                       | -            | Устанавливает минимальный размер шага категории                             |
