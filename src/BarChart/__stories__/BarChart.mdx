...
- за нулевую линию — `showGuide`. Если скрыта нулевая линия, то сетка отображаться не будет.
...
| [`showGuide?`](#отображение-линии-в-нуле)                   | `boolean`                                   | true         | Отображает линию в нуде                                                              |
